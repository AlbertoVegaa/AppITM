...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(setOf(R.id.pagina_home, R.id.pagina_1, R.id.pagina_2, R.id.pagina_3, R.id.pagina_4, R.id.pagina_5, R.id.pagina_6, R.id.pagina_7, R.id.pagina_8), drawerLayout)
