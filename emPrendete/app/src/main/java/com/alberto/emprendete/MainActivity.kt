...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener {
            makeText(this@MainActivity, "Aqui va la funcion", LENGTH_LONG).show()
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(R.id.pagina_home, R.id.pagina_1, R.id.pagina_2, R.id.pagina_3, R.id.pagina_4, R.id.pagina_5), drawerLayout)
